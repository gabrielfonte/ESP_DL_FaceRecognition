...
#ifndef ESP_DL_FACE_RECOGNITION
#define ESP_DL_FACE_RECOGNITION
...
typedef enum DLStatus {
  DLStatusOk = 0,
  DLStatusError = 1,
  DLStatusDelegateError = 2,
  DLStatusApplicationError = 3,
  DLStatusDelegateDataNotFound = 4,
  DLStatusDelegateDataWriteError = 5,
  DLStatusDelegateDataReadError = 6,
  DLStatusUnresolvedOps = 7,
} DLStatus_e;
